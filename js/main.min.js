...
class CarCard {
  constructor(e, t, n, r, i, o, s, a, l) {
    (this.src = e),
      ...
      (this.price = s),
      (this.className = a),
      (this.parentSelector = document.querySelector(l));
  }
  render() {
    ...
    e.classList.add("catalog__item"),
      ...
      `),
      this.parentSelector.append(e);
  }
}
function fillCard(e, t, n) {
  new CarCard(
    e[t].src,
    e[t].alt,
    e[t].year,
...
async function fetchingData(e, t) {
  const n = await fetch(e),
    r = await n.json();
  document.querySelectorAll(".skeleton").forEach((e) => e.remove());
  for (let e = 0; e < r.length; e++) fillCard(r, e, t);
  return document.querySelectorAll(".catalog__item");
}


function filterItems(e, t, n) {
  t.forEach((t) => {
    ...
    n.forEach((t) => {
      t.getAttribute("data-filter") === e
        ? t.classList.add("catalog__filter-btn_active")
        : t.classList.remove("catalog__filter-btn_active");
    });
}


fetchingData(
  "https://63efea4c4d5eb64db0d31d0a.mockapi.io/toyora-cars",
  ".catalog__items"
).then((e) => {
  const t = document.querySelectorAll(".catalog__filter-btn");
  t.forEach((n) => {
    n.addEventListener("click", () => {
      filterItems(n.getAttribute("data-filter"), e, t),
        n.classList.add("catalog__filter-btn_active");
    });
  });
});
